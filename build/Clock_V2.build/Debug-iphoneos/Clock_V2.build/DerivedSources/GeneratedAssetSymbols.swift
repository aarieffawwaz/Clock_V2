...
extension DeveloperToolsSupport.ImageResource {
    ...
    static let happy = DeveloperToolsSupport.ImageResource(name: "Happy", bundle: resourceBundle)
...
extension AppKit.NSImage {
    ...
    /// The "Happy" asset catalog image.
    static var happy: AppKit.NSImage {
...
extension UIKit.UIImage {
    ...
    /// The "Happy" asset catalog image.
    static var happy: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .happy)
#else
        .init()
